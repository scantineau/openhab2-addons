...
/**
 * The {@link org.openhab.binding.riscocloud.internal.RiscoCloudDiscoveryService} creates things based on the configured location.
 *
 * @author Sébastien Cantineau - Initial Contribution
 */
@NonNullByDefault
public class RiscoCloudDiscoveryService extends AbstractDiscoveryService {
    private final Logger logger = LoggerFactory.getLogger(org.openhab.binding.riscocloud.internal.RiscoCloudDiscoveryService.class);
